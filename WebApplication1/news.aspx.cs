...
namespace WebApplication1
{
    public partial class news : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ////////////////////////////////////////////
            string title0 = "select title from news order by id DESC limit " + aid + ",1";
            ...
            title0Reader.Close();
            ////////////////////////////////////////////
            string content = "select content from news order by id DESC limit " + aid + ",1";
            ...
            contentReader.Close();
            ////////////////////////////////////////////
            string date = "select date from news order by id DESC limit " + aid + ",1";

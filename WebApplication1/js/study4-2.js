...
$(document).ready(function () {
    ...
    $("#complete").click(function () {
        ...
        "<h2>您总共<span id='time3'></span></h2><a class='btn btn-success' href='study5.aspx?time=" + i + "'>进入下一关</a>" +
...
$(document).ready(function () {
    $("#flyout").click(function () {
        $(".fly-out").toggleClass("fly-out-tem");
    })
});
$(document).ready(function () {
    $("#back").click(function () {
    ...
    $("#yes").click(function () {
        if (counter == 1) {
            ...
            if (value1 != val1) {
                ...
                $("#ContentPlaceHolderMain_ps1").fadeIn();
            ...
            if (value2 != val2) {
                ...
                $("#ContentPlaceHolderMain_ps2").fadeIn();
            ...
            var val3_1 = $("#ContentPlaceHolderMain_zhuangtaisel_5")[0].nextSibling.innerHTML;
            var val3_2 = $("#ContentPlaceHolderMain_formulasel_2")[0].nextSibling.innerHTML;
            ...
            if (value3_1 != val3_1) {
                ...
                $("#ContentPlaceHolderMain_ps3").fadeIn();
                $("#g3").fadeIn();
                $("#goal4").fadeIn();
                $("#ContentPlaceHolderMain_result3").fadeOut();
                counter++;
                $("#ContentPlaceHolderMain_tip3")[0].style.color = "black";
                $("#ContentPlaceHolderMain_tip" + counter)[0].style.color = "blue";
            }
        }
        else if (counter == 4) {
            ...
            if (value4 != val4) {
                ...
                $("#ContentPlaceHolderMain_ps4").fadeIn();
                $("#flyout").fadeIn();
...
$(document).ready(function () {
    $("#Button").click(function () {
        if (counter == 1) {
            ...
            var $val3_1 = ContentPlaceHolderMain_zhuangtaisel_5.nextSibling;
            var $val3_2 = ContentPlaceHolderMain_formulasel_2.nextSibling;

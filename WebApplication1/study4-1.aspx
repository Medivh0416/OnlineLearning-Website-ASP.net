<%@ Page Title="" Language="C#" MasterPageFile="~/FrontUser.Master" AutoEventWireup="true" CodeBehind="study4-1.aspx.cs" Inherits="WebApplication1.study4_1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div id="container" runat="server">
        <div id="head" class="effect" runat="server" style="text-align: center; line-height: 70px; font-size: 19px;">
            第四关.第一问思路探索：您已用时<label id="time0" style="width: 25px;">0</label>时<label id="time1" style="width: 25px;">0</label>分<label id="time2" style="width: 25px;">0</label>秒
        </div>
        ...
        <div id="middle1" class="effect" runat="server">
           <%-- 1--%>
            ...
            <div id="g3" style="display: none"><span id="goal3_text" runat="server"></span></div>
            ...
            <span id="task4" class="icon-question-sign task" style="display: none"></span>
            <br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderScript" runat="server">
    <script type="text/javascript" src="js/study4-1.js">  </script>
